...
\usepackage{newfloat}
\usepackage{capt-of}
\DeclareFloatingEnvironment[name=Листинг,fileext=lol]{listing}
\setmonofont{Menlo}
...
\newcommand{\binokl}{\raisebox{-0.2ex}{\includegraphics[height=0.7em]{binokl.png}}}
...
\newcommand{\gocap}[2]{%
  ...
  \refstepcounter{listing}% advance and make labelable
  \noindent{\small\bfseries Листинг~\thelisting: }{\small #1}%
  \par\vspace{3pt}%
  \label{#2}%
}
